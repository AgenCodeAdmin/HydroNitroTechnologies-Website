...
import { Check, ArrowRight, ArrowLeft, MessageSquare, Star, Layout, FileText, ShoppingBag, ShieldCheck, Zap } from 'lucide-react';

// Precision Numeric Animation with Stable Width to prevent shaking
const AnimateNumber = ({ 
  start,
  end, 
  duration = 1500, 
...
const GoldWocPage = () => {
  ...
  const proFeatures = [
    { title: "Individual Product Portals", desc: "Dedicated, SEO-indexed pages for every item in your collection.", icon: <Layout className="w-6 h-6 text-blue-600" /> },
    { title: "VIP WhatsApp Concierge", desc: "Direct real-time chat integration to close sales instantly.", icon: <MessageSquare className="w-6 h-6 text-blue-600" /> },
    { title: "Verified Social Proof", desc: "A dedicated review management system to build brand authority.", icon: <Star className="w-6 h-6 text-blue-600" /> },
    { title: "Compliance Suite", desc: "Professional Terms, Conditions, and Return policy frameworks.", icon: <FileText className="w-6 h-6 text-blue-600" /> }
  ];

  return (
    <div className="min-h-screen bg-white font-sans selection:bg-blue-100 overflow-x-hidden">
      <SEO 
        title="Gold WOC Plan | Professional E-Commerce Website in Karnataka"
        description="Scale your B2C brand with the Gold WOC Plan by Hydro Nitro Technologies LLP. Premium e-commerce development with advanced features for Karnataka retailers."
        keywords="professional e-commerce website, gold woc plan, scale e-commerce business karnataka, premium online catalog hubli, advanced digital storefront, custom ecommerce website development, hire ecommerce developers, headless ecommerce architecture benefits, b2b ecommerce platform development, custom shopify web development agency, magento custom ecommerce development, custom online storefront builder price, ecommerce payment gateway integration services, secure multi vendor ecommerce website development, custom web design for online retail store"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Product",
          "name": "Gold WOC Plan",
          "description": "Advanced e-commerce website development for scaling B2C brands.",
          "offers": {
            "@type": "Offer",
            "price": "19999",
            "priceCurrency": "INR"
      ...
      <section className="relative pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-heading text-6xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter text-slate-900 mb-8 leading-[0.85] animate-in fade-in slide-in-from-bottom-10 duration-1000">
            THE CONVERSION <br />
            <span className="text-blue-600 italic uppercase">Engine.</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start md:items-center mt-12 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
            <div className="flex-1">
              <p className="text-xl md:text-2xl text-slate-500 font-medium leading-relaxed max-w-2xl">
                The Gold WOC is the industry standard for scaling brands. 
                Everything in Silver, supercharged with deep engagement tools.
              </p>
            </div>
            <div className="flex-shrink-0 bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-2xl">
              <div className="text-[0.6rem] font-black uppercase tracking-[0.3em] text-blue-400 mb-2 italic">The Pro Choice</div>
              <div className="relative inline-block w-fit mb-1 opacity-50 text-lg line-through decoration-red-500">₹32,000</div>
              <div className="text-4xl md:text-5xl font-heading font-black">
                <AnimateNumber start={32000} end={25999} prefix="₹" isPrice={true} mode="down" />
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-slate-50 rounded-[3rem] my-12 border border-slate-100">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <h2 className="font-heading text-4xl md:text-6xl font-black tracking-tighter uppercase mb-6">
            Anatomy of <span className="text-blue-600">Growth.</span>
          </h2>
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">
            Advanced features designed to turn browsers into loyal customers.
          </p>
        </div>
      ...
      {/* Scalability Section - Increased Mobile Number Visibility */}
      <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center relative">
        <div className="flex-1 relative animate-in fade-in slide-in-from-left-10 duration-1000 z-10">
          <div className="text-[50vw] lg:text-[25vw] font-black text-blue-600/5 absolute -top-20 -left-10 leading-none select-none pointer-events-none">999</div>
          <h2 className="font-heading text-5xl md:text-7xl font-black tracking-tighter leading-none mb-8 relative z-10 uppercase">
            EXTENDED <br /> CAPACITY.
          </h2>
          <p className="text-xl text-slate-500 leading-relaxed mb-10 relative z-10 font-medium">
            Gold WOC is built for established inventories. With a capacity of up to **999 Products**, 
            your store can grow without limits.
          </p>
          <div className="flex items-center space-x-8 relative z-10">
            <div>
              <div className="text-4xl font-black font-heading text-blue-600">
                <AnimateNumber end={999} />
              </div>
              <div className="text-[0.6rem] font-black uppercase tracking-widest text-slate-400">Products Capacity</div>
            </div>
            <div className="h-12 w-[1px] bg-slate-200" />
            <div>
              <div className="text-4xl font-black font-heading text-blue-600">5X</div>
              <div className="text-[0.6rem] font-black uppercase tracking-widest text-slate-400">Brand Power</div>
            </div>
          </div>
        </div>
        <div className="flex-1 bg-slate-900 rounded-[3.5rem] p-12 overflow-hidden shadow-2xl relative min-h-[500px] flex items-center justify-center animate-in fade-in slide-in-from-right-10 duration-1000">
           <Zap className="w-64 h-64 text-blue-600/20 absolute -bottom-10 -right-10 transform rotate-12" />
           <div className="relative z-10 text-center px-4">
              <div className="bg-blue-600/20 text-blue-400 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest inline-block mb-6 border border-blue-500/20">Pro Evolution</div>
              <h3 className="text-white font-heading text-4xl font-bold mb-6 tracking-tighter uppercase">Scale with <br/> Certainty.</h3>
              <p className="text-slate-400 text-lg font-medium max-w-sm mx-auto">Advanced infrastructure optimized for high-traffic luxury brands.</p>
           </div>
        </div>
      </section>
      ...
      <section className="py-40 px-4 text-center bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <h2 className="font-heading text-5xl md:text-8xl font-black mb-10 tracking-tighter uppercase italic leading-none animate-in slide-in-from-bottom-10 duration-1000">Ready to Scale?</h2>
          <p className="text-xl text-slate-400 mb-14 animate-in fade-in duration-1000 delay-300">Upgrade to the industry standard and transform your digital storefront today.</p>
          <div className="flex justify-center w-full">
            <Button asChild size="lg" className="h-16 md:h-20 w-full md:w-auto px-10 md:px-16 rounded-full bg-blue-600 text-white text-base md:text-xl font-black uppercase tracking-[0.2em] hover:bg-blue-500 transition-all duration-500 shadow-[0_0_50px_rgba(37,99,235,0.3)] active:scale-95 group">
              <Link to="/#contact" className="flex items-center justify-center">
                Upgrade to Gold WOC <ArrowRight className="ml-3 w-5 h-5 transition-transform group-hover:translate-x-2" />
              </Link>
            </Button>
          </div>
        </div>
